        ...
        <div className="flex items-center justify-between h-16 gap-2 overflow-hidden">
          ...
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="hidden sm:inline text-[9px] sm:text-[10px] font-semibold uppercase tracking-wider bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 px-1.5 sm:px-2 py-0.5 rounded-full whitespace-nowrap">
                  MinC • SALIC
                </span>
              </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            {onOpenLangChainModal && (
              ...
              className="hidden lg:flex text-[11px] sm:text-xs bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 font-semibold px-2.5 sm:px-3 py-2 rounded-xl items-center gap-1.5 transition min-h-[38px]"
              >
