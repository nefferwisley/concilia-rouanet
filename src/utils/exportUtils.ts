...
export function exportSalicExcel(
  ...
  const resumoData = [
    ...
    ["Valor Total Aprovado (Captação):", project.valorAprovado ?? "Não informado"],
    ["Rendimentos de Aplicação Financeira (BB):", project.bancoInfo?.rendimentoAplicacao ?? "Não informado"],
    ["Total de Recursos Disponíveis:", project.valorAprovado != null && project.bancoInfo?.rendimentoAplicacao != null ? project.valorAprovado + project.bancoInfo.rendimentoAplicacao : "Não informado"],
    ["Total de Despesas Executadas:", project.valorExecutado ?? "Não informado"],
    ["Saldo Remanescente a Recolher ao Fundo:", project.valorAprovado != null && project.bancoInfo?.rendimentoAplicacao != null && project.valorExecutado != null ? project.valorAprovado + project.bancoInfo.rendimentoAplicacao - project.valorExecutado : "Não informado"],
    [""],
